...
SECONDARYTASK: MoveDebugCustom to new project  file Called DebugToolsForJsonUtilities
SECONDARYTASK: JsonUtilities003 From console project to dll library
...
namespace FileUtilities
{
	...
	namespace Prefabs
	{
		public class LoadFileToListThenSortAndCap
		{
		...
		public class CreateFileSortWriteToJson
		{
			public static void Begin<T>(CustomJsonFile<T> myJsonFile, Func<T, IComparable> getProp)
			{
